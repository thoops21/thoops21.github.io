...
### This is a map that shows all of the listings in DC. Until you zoom in, it's in a clustered state. Each point has a location that you can pick and click to see the Name, Host Name, Price, Room Type, and Property Type.
...
### These represent the good words pulled from the review: comfortable, clean, space, stylish, spacious, cozy, and nice.
